    ...
    >
      ...
      <div className="flex flex-col mr-6">
        <div className="flex flex-col flex-1 mt-10 mb-4">
          <p className="mb-1 ml-1 text-sm md:text-md opacity-80">username</p>
          <input
            type="text"
            className="flex-1 px-2 py-2 transition-opacity duration-300 border-2 bg-100vh-gray focus:opacity-100 opacity-60"
        ...
        <div className="relative flex flex-col flex-1 mb-4">
          <p className="mb-1 ml-1 text-sm md:text-md opacity-80">email</p>
          <input
            disabled={true}
            type="text"
        ...
        <div className="flex items-center mb-4">
          <div className="flex flex-col flex-1 mr-1 md:mr-2">
            ...
            <input
              ...
              className="flex-1 px-2 py-2 transition-opacity duration-300 border-2 bg-100vh-gray focus:opacity-100 opacity-60"
              style={{ borderColor: "#282828" }}
              value={user ? (user as any)?.name?.split(" ")[0] : ""}
            />
          </div>
          <div className="flex flex-col flex-1 ml-1 md:ml-2">
            <p className="mb-1 ml-1 text-sm md:text-md opacity-80">last name</p>
            <input
              type="text"
              className="flex-1 px-2 py-2 transition-opacity duration-300 border-2 bg-100vh-gray focus:opacity-100 opacity-60"
              style={{ borderColor: "#282828" }}
              value={user ? (user as any)?.name?.split(" ")[1] : ""}
            />
          </div>
        </div>

        <div className="relative flex flex-col flex-1 mb-4">
          <p className="mb-1 ml-1 text-sm md:text-md opacity-80">bio</p>
          <input
            type="text"
            className="flex-1 px-2 py-2 transition-opacity duration-300 border-2 opacity-60 bg-100vh-gray focus:opacity-100"
            style={{ borderColor: "#282828" }}
